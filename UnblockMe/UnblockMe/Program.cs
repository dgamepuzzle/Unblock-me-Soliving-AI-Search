...
namespace UnblockMe
{
    class Program
    {
        ...
        public static Tree A_Star(List<int[]> blueprint, int limit)
        {

            long memory_s = GC.GetTotalMemory(true);
            long max_mem = 0;
            ...
            while (gameStack.Count > 0)
            {
                ...
                if (currentNode.isReachGoal())
                {
                    ...
                    long mem_e = (max_mem - memory_s) / 1024;
                    Console.Write("Memory is " + mem_e + " MB \n");
                    found = true;
                    //end of search
                    break;
                ...
                else
                {
                    ...
                    // return root;
                    List<Tree> objListOrder = currentNode.childList;
                    List<Tree> SortedList = objListOrder.OrderBy(o => o.cost).ToList();
